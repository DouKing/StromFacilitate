...
@property (nonatomic, assign) IBInspectable NSInteger limitTypeAdapter;
@end
...
- (void)setLimitTypeAdapter:(NSInteger)limitTypeAdapter {
  self.limitType = limitTypeAdapter;
}

- (NSInteger)limitTypeAdapter {
